...
<%
	...
	String [] Userday=(String [])session.getAttribute("Userday");//사용자 선택요일 가져오기.
...
<table border="1" width="600px"     >
	...
	for( Userdietdb item : morninglst)
	{
		...
		System.out.println("출력 작동 중");
	%>
	<td ><a href="<%=contextPath %>/ThreeDetailMenu/ThreeDetailMenuProc.jsp
	?resname1=<%=item.getResname1()%>
	&resname2=<%=item.getResname2()%>&resname3=<%=item.getResname3()%>" >
